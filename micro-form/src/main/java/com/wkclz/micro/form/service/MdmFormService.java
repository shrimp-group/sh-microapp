...
import com.wkclz.micro.form.mapper.MdmFormItemMapper;
import com.wkclz.micro.form.mapper.MdmFormMapper;
...
public class MdmFormService extends BaseService<MdmForm, MdmFormMapper> {
    ...
    public MdmForm update(MdmFormDto dto) {
        ...
        if (!CollectionUtils.isEmpty(deleteItemIds)) {
            mdmFormItemMapper.deleteByIds(deleteItemIds);
        }
        return oldEntity;
    }
    ...
    public Integer customRemove(MdmForm entity) {
        ...
        mdmFormItemMapper.deleteByIds(ids);
