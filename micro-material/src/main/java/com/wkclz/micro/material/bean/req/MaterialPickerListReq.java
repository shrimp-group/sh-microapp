...
@Schema(description = "素材选择器列表查询请求")
public class MaterialPickerListReq extends PageReq {
    ...
    @NotNull(message = "timeFrom can not be null")
    @Schema(description = "创建时间从")
    private LocalDateTime timeFrom;

    @NotNull(message = "timeTo can not be null")
