...
public class FileBucketRest {

    @Autowired
    private MdmFileBucketService mdmFileBucketService;
    ...
    public R mdmFileBucketPage(MdmFileBucket entity) {
        PageData page = mdmFileBucketService.getPage(entity);
        return R.ok(page);
    }
    ...
    public R mdmFileBucketInfo(MdmFileBucket entity) {
        entity = mdmFileBucketService.getInfo(entity);
        return R.ok(entity);
    }
    ...
    public R mdmFileBucketCreate(@RequestBody MdmFileBucket entity) {
        ...
        mdmFileBucketService.insert(entity);
        return R.ok(entity);
    }
    ...
    public R mdmFileBucketUpdate(@RequestBody MdmFileBucket entity) {
        ...
        entity = mdmFileBucketService.update(entity);
        return R.ok(entity);
    }
    ...
    public R mdmFileBucketRemove(@RequestBody MdmFileBucket entity) {
        Assert.notNull(entity.getId(), ResultCode.PARAM_NO_ID.getMessage());
        mdmFileBucketService.remove(entity);
        return R.ok(1);
    }
    ...
    public R fsBucketOptions(MdmFileBucket entity) {
        List<MdmFileBucket> options = mdmFileBucketService.getBucketOptions(entity);
        return R.ok(options);
    }
