...
public class ManagerNotificationRest {
    ...
    /**
     * @api {get} /micro-msg/manager/notification/page 01. 管理员消息分页
     * @apiGroup MSG
     *
     * @apiVersion 0.0.1
    ...
    public R managerNotificationPage(MsgNotificationDto entity) {
    ...
    /**
     * @api {post} /micro-msg/manager/notification/sent 02. 管理员消息发布
     * @apiGroup MSG
     *
     * @apiVersion 0.0.1
    ...
    public R managerNotificationSent(@RequestBody MsgNotificationDto dto) {
    ...
    /**
     * @api {get} /micro-msg/manager/notification/info 03. 管理员消息详情
     * @apiGroup MSG
     *
     * @apiVersion 0.0.1
    ...
    public R managerNotificationInfo(MsgNotification entity) {
    ...
    /**
     * @api {get} /micro-msg/manager/notification/record/page 04. 管理员消息阅读记录
     * @apiGroup MSG
     *
     * @apiVersion 0.0.1
     * @apiDescription 消息通知-获取分页
    ...
    public R managerNotificationRecordPage(MsgUserRecord entity) {
