...
public enum ContentTypeEnum {
    ...
    DTD(".dtd", "text/xml", ""),
    DWF(".dwf", "application/x-dwf", "Model/vnd.dwf"),
    ...
    EPS(".eps", "application/x-ps", "application/postscript"),
    ...
    ICO(".ico", "image/x-icon", "application/x-ico"),
    ...
    JPE(".jpe", "image/jpeg", "application/x-jpe"),
    JPEG(".jpeg", "image/jpeg", ""),
    JPG(".jpg", "image/jpeg", "application/x-jpg"),
    ...
    MATH(".math", "text/xml", ""),
    MDB(".mdb", "application/x-mdb", "application/msaccess"),
    ...
    PNG(".png", "image/png", "application/x-png"),
    ...
    PPT(".ppt", "application/x-ppt", "application/vnd.ms-powerpoint"),
    PPTX(".pptx", "application/x-ppt", "application/vnd.ms-powerpoint"),
    PR(".pr", "application/x-pr", ""),
    PRF(".prf", "application/pics-rules", ""),
    PRN(".prn", "application/x-prn", ""),
    PRT(".prt", "application/x-prt", ""),
    PS(".ps", "application/x-ps", "application/postscript"),
    ...
    RTF(".rtf", "application/x-rtf", "application/msword"),
    ...
    TIF(".tif", "image/tiff", "application/x-tif"),
    ...
    VSD(".vsd", "application/x-vsd", "application/vnd.visio"),
    VSS(".vss", "application/vnd.visio", ""),
    VST(".vst", "application/x-vst", "application/vnd.visio"),
    ...
    XLS(".xls", "application/x-xls", "application/vnd.ms-excel"),
    XLSZ(".xlsz", "application/x-xlsx", "application/vnd.ms-excel"),
    ...
    ContentTypeEnum(String sub, String contentType, String contentType2) {
        this.sub = sub;
