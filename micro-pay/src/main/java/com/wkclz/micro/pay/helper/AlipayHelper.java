    ...
    public PayOrder payNotify(HttpServletRequest req, HttpServletResponse rep, PayOrder payOrder, AlipayNotify notify) {
        ...
        */
        ...
        if ("TRADE_FINISHED".equals(tradeStatus)) {
            ...
            String gmtPayment = new String(req.getParameter("gmt_payment").getBytes(StandardCharsets.ISO_8859_1), StandardCharsets.UTF_8);
            LocalDateTime gmtPaymentTime = LocalDateTimeUtil.parse(gmtPayment, "yyyy-MM-dd HH:mm:ss");

            payOrder.setPayStatus(PayStatus.PAID.name());
            payOrder.setPayFlowNo(tradeNo);
            payOrder.setPayTime(gmtPaymentTime);
            return payOrder;
        }
