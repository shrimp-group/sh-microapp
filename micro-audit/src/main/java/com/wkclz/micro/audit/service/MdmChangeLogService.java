...
import com.wkclz.micro.audit.mapper.MdmChangeLogMapper;
...
public class MdmChangeLogService extends BaseService<MdmChangeLog, MdmChangeLogMapper> {
    ...
    public PageData<MdmChangeLog> getChangeLogPage(MdmChangeLog entity) {
        return PageQuery.page(entity, mapper::getChangeLogList);
    }
